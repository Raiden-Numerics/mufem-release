...
<div align="center">
    ...
    <br/>
    Figure 3: A prismatic boundary layer is used (Element Type: 6) to effectively capture the skin-depth effects. The
...
![Coil Current](results/Coil_Current_vs_Time.png)

The current rise is well reproduced.


![Magnetic Torque](results/Rotor_Torque_vs_Time.png)
